...
<body>
	<input type="hidden" name="REPORT_INDEX" value="${boarddata.REPORT_INDEX}">
	<div class="wrapper">
		<!-- header start -->
									...
									<div class="login-form-container">
										<div class="login-form">
											<form action="BoardModifyAction.bo" method="post"
												...
												<span style="margin-top:30px;">작성자</span> <input type="text" id="REPORT_WRITER" name="REPORT_WRITER"
													 class="oneday_write_form" value="${boarddata.REPORT_WRITER}" readonly>
												...
												<span>분류</span> <select name="REPORT_TYPE" id="REPORT_TYPE" style="margin-bottom: 30px">
												 ...
												 <span>제목</span> <input type="text" name="REPORT_TITLE" id="REPORT_TITLE"
													value="신고합니다." size="50" class="oneday_write_form" readonly="readonly" >
													
													<span>신고할 사용자 아이디</span> <input type="text" name="REPORT_REPORT" id="REPORT_REPORT"
													size="50" class="oneday_write_form" value="${boarddata.REPORT_REPORT}" >

													<span>내용</span>
												<textarea name="REPORT_CONTENT" id="summernote">${boarddata.REPORT_CONTENT}</textarea>
	...
	<script>
		...
		function goWrite(frm) {
			var content = frm.REPORT_CONTENT.value;
