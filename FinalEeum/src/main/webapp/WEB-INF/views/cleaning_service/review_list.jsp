...
<script src="resources/js/service/jquery.barfiller.js"></script>
...
<body>
	...
	<div id="comment">
		...
		<!-- 친절함  -->
		<b id="tag1" style="font-size: 20px; position: relative; top: 30px;">친절함
			: </b><span class="svg-star-rating1 jq-stars"
