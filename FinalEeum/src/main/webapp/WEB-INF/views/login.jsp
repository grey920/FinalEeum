                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="login-form-container">
                                            <div class="login-form">
                                                <form action="#" method="post">
                                                    <input type="text" name="user-name" placeholder="사용자 ID">
                                                    <input type="password" name="user-password" placeholder="사용자 비밀번호">
                                    ...
                                    <div id="lg2" class="tab-pane">
                                        <div class="login-form-container">
                                            <div class="login-form">
                                                <form action="#" method="post">
                                                    <input type="text" name="user-name" placeholder="전문가 ID">
                                                    <input type="password" name="user-password" placeholder="전문가 비밀번호">
                                                    <div class="button-box">
                                                        <div class="login-toggle-btn">
                                                            <input type="checkbox">
                                                            <label>ID 기억하기</label>
