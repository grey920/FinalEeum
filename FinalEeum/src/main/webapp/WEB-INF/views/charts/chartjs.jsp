            ...
            <div class="card">
              <div class="card-header" style="background:#F7E590;">
                ...
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus" style="color:#8a7c38"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times" style="color:#8a7c38"></i></button>
                </div>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header" style="background:#DBE8AE;">
                ...
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"style="color:#79825b"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times" style="color:#79825b"></i></button>
                </div>
              </div>
              <div class="card-body">
                <div class="chart">
