...
.btn-style.pwd{margin-top:10px !important;
       			margin-right:0px;
       			font-size:18px;
         		border-radius:20px;
...
.btn-style.pwd:hover{background-color:#72A0E0;
         					color:white;
         					border:2px solid #72A0E0;}
.btn-style.login{margin-top:10px !important;
       					margin-right:0px;
       					font-size:18px;
         				border-radius:20px;
         				...
         				color:white;
         				border:2px solid #72A0E0 !important;}
.btn-style.login:hover{background-color:white;
									color:#72A0E0;}
                                    ...
                                    <div id="lg1" class="tab-pane active">
                                        <div class="login-form-container">
                                            <div class="login-form" style="text-align:center; margin:0 auto">
												이음 전문가의 정보와 일치한 아이디는 " 
												<span style="font-size:16pt; font-weight:700">${expert_id}</span>
												 " 입니다.
												
                                                <div class="button-box" style="text-align:center; margin:0 auto">
                                                   <button class="btn-style login" onclick="location.href='login.net';" style="margin-right:20px">
                                                   		<span>로그인 하기</span>
                                                   </button>
                                                   
                                                   <button class="btn-style pwd" onclick="location.href='expertFind.net';">
                                                   		<span>비밀번호 찾기</span>
                                                   </button>
                                                </div>
