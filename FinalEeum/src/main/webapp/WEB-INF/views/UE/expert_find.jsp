                            ...
                            <div class="login-register-wrapper">
                                ...
                                <div class="tab-content">
                                    <div id="lg1" class="tab-pane active">
                                        <div class="login-form-container">
                                            <div class="login-form">
                                                <form name="expertFindId" action="expertIdProcess.net" method="post">
                                                	<p>전문가 이름 *</p>
                                    ...
                                    <div id="lg2" class="tab-pane">
                                        <div class="login-form-container">
                                            <div class="login-form">
                                                <form name="expertFindPwd" action="expertPwdProcess.net" method="post">
                                                	<p>전문가 아이디 *</p>
                                                    <input type="text" id="expert_id" name="expert_id" placeholder="전문가 아이디">
                                                	<p>전문가 이름 *</p>
