					...
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-5 col-5">
							...
							<div class="sticky-logo"> <!-- 스크롤내렸을 때,메뉴바 로고  -->
								<a href="index.html"><img src="resources/img/logo/eeum_logo.png"
									alt="" /></a>
							</div>
							<div class="logo-small-device">	<!-- 반응형 웹 작게했을 때 로고 -->
								<a href="index.html"><img alt=""
									src="resources/img/logo/eeum_logo(2).jpg"></a>
							</div>
						</div>
						<div class="col-lg-8 col-md-8 d-none d-md-block">
							<div class="logo-menu-wrapper text-center">
								<div class="logo">	<!-- 반응형 웹 크게했을 때 로고 -->
									<a href="index.html"><img src="resources/img/logo/eeum_logo(2).jpg"
										alt=""  /></a>
								</div>
								<div class="main-menu">
									<nav>
										...
										<div class="login-form">
											<form action="joinProcess.net" method="post" enctype="multipart/form-data">
												...
												<label for="user_profile">
												   <p><img src="resources/img/profile/profile.png" alt="profile" id="profile" 
												   			style="width:200px;height:200px;border-radius:50%;margin-left:140px;">
												   </p>
												</label>
												</div>
												
												<p>주민등록 번호 *</p><!-- 숫자만 -->
												<input type="text" id="user_jumin1" name="user_jumin1"  maxLength="6" style="width:46%">
												<b>&nbsp;-&nbsp;</b>
												<input type="password" id="user_jumin2" name="user_jumin2" maxLength="7" style="width:46%">
												...
												<p>휴대폰 번호 * </p> <!-- 숫자만 -->
												<input type="text" id="user_phone1" name="user_phone1" value="010" style="width:25%;text-align:center" >
												<b>-</b>
												<input type="text" id="user_phone2" name="user_phone2" maxLength="4" style="width:34%;text-align:center" >
												<b>-</b>
												<input type="text" id="user_phone3" name="user_phone3" maxLength="4" style="width:34%;text-align:center" >
												<span id="message_phone"></span>
												
												<p>이메일 주소 *</p>
												<input type="text" id="user_email1" name="user_email1" placeholder="이메일 주소를 입력하세요" style="width:42%">
												<b>&nbsp;@&nbsp;</b>
