...
select sum(rv_rating1) "rv_rating1",sum(rv_rating2) "rv_rating2",sum(rv_rating3) "rv_rating3",sum(rv_rating4) "rv_rating4",sum(rv_rating5) "rv_rating5",sum(rv_rating6) "rv_rating6",
		count(*) "rating_count"
		from review
